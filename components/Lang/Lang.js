  ...
  return (
    <div ref={ref} className="relative">
      ...
      <div
        ...
        } absolute border mt-2 origin-top-right right-0 ring-1 ring-black ring-opacity-5 rounded-md shadow-lg z-20 w-14`}
      >
        <div
          className="py-1"
          role="menu"
        ...
        >
          {Object.keys(locales)
            ...
            .map((key) => (
              ...
              >
                <a
                  className="block hover:bg-blue-800 px-4 py-2 text-gray-700 text-2xl"
                  role="menuitem"
                >
                  {locales[key]()}
                </a>
